...
Furthermore, it appears that the publicly accessible data within \maude is only a recently phenomenon, with \Fref{fig:totalgraph} showing how the public data present increases massively over the period covered.
